...
function _renderDefs() {
  ...
  return config => {
    ...
    if (!markerCache[key]) {
      ...
      markerCache[key] = (
        <defs>
          <Marker id={MARKERS.MARKER_S} refX={small} fill={color} {...markerProps} orient='auto' />
          <Marker id={MARKERS.MARKER_SH} refX={small} fill={highlightColor} {...markerProps} orient='auto' />
          <Marker id={MARKERS.MARKER_M} refX={medium} fill={color} {...markerProps} orient='auto' />
          <Marker id={MARKERS.MARKER_MH} refX={medium} fill={highlightColor} {...markerProps} orient='auto' />
          <Marker id={MARKERS.MARKER_L} refX={large} fill={color} {...markerProps} orient='auto' />
          <Marker id={MARKERS.MARKER_LH} refX={large} fill={highlightColor} {...markerProps} orient='auto' />
          <Marker id={MARKERS.MARKER_S_I} refX={small} fill={color} {...markerProps} orient='auto-start-reverse' />
          <Marker id={MARKERS.MARKER_SH_I} refX={small} fill={highlightColor} {...markerProps} orient='auto-start-reverse' />
          <Marker id={MARKERS.MARKER_M_I} refX={medium} fill={color} {...markerProps} orient='auto-start-reverse' />
          <Marker id={MARKERS.MARKER_MH_I} refX={medium} fill={highlightColor} {...markerProps} orient='auto-start-reverse' />
          <Marker id={MARKERS.MARKER_L_I} refX={large} fill={color} {...markerProps} orient='auto-start-reverse' />
          <Marker id={MARKERS.MARKER_LH_I} refX={large} fill={highlightColor} {...markerProps} orient='auto-start-reverse' />
        </defs>
      );
    }
