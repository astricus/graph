...
export default function RightSidebar({ open }) {
  return (
    <div>
      {/* <button
      ...
      <aside
        id='default-sidebar'
        className={cn('absolute top-0 right-0 z-40 w-64 h-screen transition-transform', { 'translate-x-full': !open, 'translate-x-0': open })}
        aria-label='Sidenav'
      >
