  ...
  return (
    <div>
      <aside
        ...
        aria-label="Left sidenav"
      >
        <div className="flex flex-col gap-10 overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          <Concepts />
          <Relations />
        </div>
        <Button
